...
use App\Filters\V1\UserSearchFilter;
...
class UserController extends Controller
{
     ...
     * 
     * @param \App\Http\Requests\Api\V1\StoreUserRequest $request 已驗證的請求資料
     * @responseFile status=201 storage/responses/user.show.json
     * @return \App\Http\Resources\Api\V1\UserResource 新建立的用戶資源
     */
     ...
     * @return \App\Http\Resources\Api\V1\UserResource 用戶資源
     */
     ...
     * 
     * @param \App\Http\Requests\Api\V1\UpdateUserRequest $request 已驗證的請求資料
     * @param \App\Models\User $user 要更新的用戶模型實例（透過路由模型綁定自動解析）
     * @urlParam user integer required 用戶的 ID。 Example: 1
     * @responseFile storage/responses/user.show.json
     * @return \App\Http\Resources\Api\V1\UserResource 更新後的用戶資源
     */
