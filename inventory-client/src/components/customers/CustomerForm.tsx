...
export function CustomerForm({ initialData, isSubmitting, onSubmit }: CustomerFormProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center space-x-2 pt-2">
                      ...
                      <FormLabel className="text-sm font-normal">設為預設</FormLabel>
                    </FormItem>
                  )}
                />
                <Button
          ...
          <Button
            type="button"
            variant="outline"
            onClick={() => append({ address: '', is_default: fields.length === 0 })}
          >
