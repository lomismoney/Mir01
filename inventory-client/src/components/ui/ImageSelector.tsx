...
export function ImageSelector({
  ...
  return (
    <div className={cn("space-y-4", className)} data-oid="_7r9:1f">
      {!imageData.file && !imageData.preview ? (
          ...
          >
            ...
            >
              ...
              <p
                ...
                data-oid="tt29qqm"
              >
                <span className="font-semibold" data-oid=":fycwis">
                  點擊上傳
                </span>{" "}
                或拖曳檔案至此
              </p>
              <p className="text-xs text-muted-foreground" data-oid="9lodwfj">
                {acceptedFormats
        ...
        // 圖片預覽區域
        <div className="relative" data-oid="09xz15p">
          <div
          ...
          >
            ...
            <Button
              ...
              data-oid="ers5nrt"
            >
              <X className="h-4 w-4" data-oid="n4p82mz" />
            </Button>
          </div>
          ...
          {imageData.file && (
            <div
              ...
              data-oid="mog__jp"
            >
              <p data-oid="-4qb4.e">檔案名稱：{imageData.file.name}</p>
              <p data-oid="m9-s1ic">
                檔案大小：{formatFileSize(imageData.file.size)}
              </p>
              <p data-oid="m5bgmxq">檔案格式：{imageData.file.type}</p>
            </div>
          )}
        </div>
      )}
      ...
      {!imageData.isValid && imageData.validationError && (
        <Alert variant="destructive" data-oid="m:zi2fr">
          <AlertCircle className="h-4 w-4" data-oid="nam2m49" />
          <AlertDescription data-oid="gy6:gb2">
